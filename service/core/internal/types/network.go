...
type NetworkAdapter interface {
	...
	TxSendBase(ctx *RPCContext, to string, value string, gas, gasTipCap, gasFeeCap uint64, key *ecdsa.PrivateKey) (interface{}, error)
	...
	// w3 direct calls
	GetBlockJson(ctx *RPCContext, blockNumber uint64) ([]byte, error)
