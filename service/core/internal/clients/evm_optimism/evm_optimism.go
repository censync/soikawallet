...
type EVMOptimism struct {
	*evm_legacy.EVMLegacy
}

func NewEVMOptimism(baseNetwork *types.BaseNetwork) *EVMOptimism {
	return &EVMOptimism{EVMLegacy: evm_legacy.NewEVMLegacy(baseNetwork)}
}

func (e *EVMOptimism) GetGasConfig(ctx *types.RPCContext, args ...interface{}) (map[string]uint64, error) {
